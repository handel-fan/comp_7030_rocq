...
\begin{itemize}[leftmargin=*]
    \item COMP 7030 CS Research -- Rocq 
    \item COMP 5300 Effective Functional Programming 
    \item COMP 5300 Deep Learning: LLMs and LVMs 
...
\textbf{General:} Formal Verification, Compilers, Deep Learning \\
\textbf{Languages:} \cplusplus, Python, Rocq, Haskell, \csharp, Typescript \\
\textbf{Systems:} Linux \\
...
\begin{itemize}[leftmargin=*]
    \item Porting an interpreter for the Monkey programming language from \cplusplus{} to Go \\
...
\begin{itemize}[leftmargin=*]
    \item Led technical debt initiatives to improve code quality and maintainability, 
      allowing the team to move away from old unsupported PHP framework and into \csharp{} code.
      This improved security, and decreased time to implement features across the entire time.
...
\begin{itemize}[leftmargin=*]
    \item Developed C\# backend services which supported frontend features
    % TODO: Which ones?
    \item Worked across multiple technologies in a production environment
    \item Promoted within 6 months because of my rapid feature delivery.
\end{itemize}
